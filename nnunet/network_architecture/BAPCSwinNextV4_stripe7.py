...
class BasicLayer(nn.Module):
    ...
    def __init__(self, num_stage, num_only_conv_stage, num_pool, base_num_features, input_resolution, depth, num_heads,
        ...
        from nnunet.network_architecture.CSwinTrans.cswin3D_hv_cpe import CSWinBlock3D

        # sw setting:
        # split_size = [5, 5, 5, 10, 10]
...
class BAPCSwinNextV4_stripe7(SegmentationNetwork):
    def __init__(self,
                 img_size,
                 base_num_features,
                 num_classes,
...
if __name__ == "__main__":
    ...
    network = BAPCSwinNextV4_stripe7(img_size=patch_size,
