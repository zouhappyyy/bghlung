...
class LePEAttention(nn.Module):
    ...
    def get_lepe(self, x, func):
        ...
        # current: B 0, C 1, D // D_sp 2, D_sp 3, H // H_sp 4, H_sp 5, W // W_sp 6, W_sp 7 -> B 0, D // D_sp 2, H // H_sp 4, W // W_sp 6, C 1, D_sp 3, H_sp 5, W_sp 7
...
class CSWinBlock3DAllDim(nn.Module):
    ...
    def __init__(self, dim, reso, num_heads,
        ...
        assert dim % 3 == num_heads % 3 == dim % 3 == 0
...
if __name__ == "__main__":
    ...
    cswin_block_1 = CSWinBlock3DAllDim(
                dim=dim,
                num_heads=num_heads,
    ...
    cswin_block_2 = CSWinBlock3DAllDim(
                dim=dim,
                num_heads=num_heads,
                reso=input_resolution[0],
                mlp_ratio=mlp_ratio,
