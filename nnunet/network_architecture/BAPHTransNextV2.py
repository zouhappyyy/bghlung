...
class BAPHTransNextV2(SegmentationNetwork):
    def __init__(self,
                 img_size,
                 base_num_features,
                 num_classes,
        ...
        for i_layer in range(self.num_pool):  # 0,1,2,3
            layer = BasicLayer(num_stage=i_layer,
                               num_only_conv_stage=num_only_conv_stage, num_pool=self.num_pool,
...
if __name__ == "__main__":
    ...
    network = BAPHTransNextV2(img_size=patch_size,
...
#
#     """
#     input size: 48, 192, 192
#     net totoal parameters: 37.20M
#     FLOPS: 350.26G
#     GPU: 9G
#
