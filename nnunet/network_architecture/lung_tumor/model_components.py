...
from nnunet.network_architecture.lung_tumor.layers import LayerNorm
from nnunet.network_architecture.lung_tumor.transformerblock import TransformerBlock
from nnunet.network_architecture.lung_tumor.dynunet_block import get_conv_layer, UnetResBlock
...
class UnetrPPEncoder(nn.Module):
    """
    80*160*160: [40*40*40, 40*20*20, 20*10*10, 10*5*5]
    """
