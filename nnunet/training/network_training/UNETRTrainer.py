...
class UNETRTrainer(nnUNetTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(UNETRTrainer, self).__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
    ...
    def run_training(self):
        ...
        super(UNETRTrainer, self).run_training()
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(UNETRTrainer, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
