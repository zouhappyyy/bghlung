...
from nnunet.training.network_training.lung_unetr_pp.Trainer_lung import Trainer_lung
...
class unetr_pp_trainer_lung(Trainer_lung):
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if not self.was_initialized:
            ...
            self.plans['plans_per_stage'][0]['patch_size'] = np.array([80, 160, 160])
            self.crop_size = np.array([80, 160, 160])
