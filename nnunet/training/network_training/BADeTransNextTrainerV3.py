...
class BADeTransNextTrainerV3(nnUNetTrainerV2):
    ...
    def initialize_network(self):
        ...
        from nnunet.network_architecture.BADeTransNextV3 import BADeTransNextV3
        self.network = BADeTransNextV3(img_size=self.patch_size,
