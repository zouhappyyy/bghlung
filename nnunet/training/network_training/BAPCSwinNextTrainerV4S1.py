...
class BAPCSwinNextTrainerV4S1(nnUNetTrainerV2):
    ...
    def initialize_network(self):
        ...
        from nnunet.network_architecture.BAPCSwinNextV4_stripe1 import BAPCSwinNextV4_stripe1
        self.network = BAPCSwinNextV4_stripe1(img_size=self.patch_size,
