...
class UNet3DTrainer(nnUNetTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False):
        """
        modified from nnUNet
        """
        super(UNet3DTrainer, self).__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
    ...
    def initialize_network(self):
        ...
        self.network = UNet3D(in_channels=self.num_input_channels, out_channels=self.num_classes, init_features=32)
    ...
    def run_training(self):
        ...
        super(UNet3DTrainer, self).run_training()
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(UNet3DTrainer, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
