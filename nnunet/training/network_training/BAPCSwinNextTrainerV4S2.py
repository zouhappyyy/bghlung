...
class BAPCSwinNextTrainerV4S2(nnUNetTrainerV2):
    ...
    def initialize_network(self):
        ...
        from nnunet.network_architecture.BAPCSwinNextV4_stripe2 import BAPCSwinNextV4_stripe2
        self.network = BAPCSwinNextV4_stripe2(img_size=self.patch_size,
