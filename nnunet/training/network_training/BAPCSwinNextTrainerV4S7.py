...
class BAPCSwinNextTrainerV4S7(nnUNetTrainerV2):
    ...
    def initialize_network(self):
        ...
        from nnunet.network_architecture.BAPCSwinNextV4_stripe7 import BAPCSwinNextV4_stripe7
        self.network = BAPCSwinNextV4_stripe7(img_size=self.patch_size,
