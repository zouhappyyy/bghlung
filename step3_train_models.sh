...
# make dataset
python ./nnunet/experiment_planning/nnUNet_plan_and_preprocess.py -t 530 --verify_dataset_integrity
...
# 11nnUNetV2 0.849
CUDA_VISIBLE_DEVICES=0 nohup python ./nnunet/run/run_training.py 3d_fullres nnUNetTrainerV2 Task530_EsoTJ_30pct 1 > ./log/nnUNetV2_530_Fold1.log 2>&1 &
...
CUDA_VISIBLE_DEVICES=0 nohup python ./nnunet/run/run_training.py 3d_fullres MedNeXtTrainerV2 Task530_EsoTJ_30pct 0 > ./log/MedNeXtTrainerV2_530_Fold0.log 2>&1 &
...
# BGHNetV4 0.844
CUDA_VISIBLE_DEVICES=1 nohup python ./nnunet/run/run_training.py 3d_fullres BGHNetV4Trainer Task530_EsoTJ_30pct 1 > ./log/BGHNetV4Trainer_530_Fold1.log 2>&1 &
