...
lung_input_dir_list = ['/mnt/data1/zyzlung/Dataset/20240419_data/pre_unenhanced/image/',
                       # '/mnt/data1/zyzlung/Dataset/20240419_data/pre_enhanced/image/',
                       # '/mnt/data1/zyzlung/Dataset/20240419_data/post_unenhanced/image/',
                       # '/mnt/data1/zyzlung/Dataset/20240419_data/post_enhanced/image/',
                       ]

model_dir = 'ckpt/nnUNet/3d_fullres/Task702_LungTumor/BAPCSwinNextTrainerV4__nnUNetPlansv2.1/'
...
lung_mask_output_dir = './pred_test_unlabeled_data_mask_20240419/'
...
print(lung_input_dir_list[0].split('/'))
# assert False

for current_input_dir in lung_input_dir_list:

    current_lung_type =  current_input_dir.split('/')[-3]
    ...
    print(len(input_filename_list),input_filename_list)
